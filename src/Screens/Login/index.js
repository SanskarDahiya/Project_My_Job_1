...
import { setAccessToken, setUserDetails } from "../../Redux/persistedSlice";
import { setLoading } from "../../Redux/sessionSlice";
      ...
      <div className="container">
        ...
        >
          ...
          <div className="input-container">
            ...
            <span className="error">{errors.email?.type === "required" && "Field is required"}</span>
          </div>
          <div className="input-container">
            <div style={{ marginBottom: 8, display: "flex", justifyContent: "space-between", width: "100%" }}>
              <label>Password</label>
              <Link style={{ color: "#43AFFF", marginInlineStart: 10, fontSize: 14 }} to="/forgot">
                Forgot Password
              </Link>
            </div>
            <input
          ...
          <div style={{ width: "100%" }}>
            New to MyJobs?
            <Link style={{ color: "#43AFFF", marginInlineStart: 10 }} to="/register">
              Create an account
            </Link>
          </div>
        </form>
